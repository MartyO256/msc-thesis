...
When it comes to theorem provers, one example of structured editing is the \textsc{CoqIDE}, which leverages the \textsc{Coq} \texttt{XML} protocol to interact with the proof system's kernel by way of messages.
...
Indeed, like in \textsc{Hazel} and \textsc{Coq}, users of \Beluga and \Harpoon postpone the completion of programs or proof scripts by inserting holes in them.

...
As part of this thesis, \Beluga's parser was reimplemented to address correctness issues, handle expressions in non-canonical form to improve error reporting, to support user-defined operators at the level of computations, and to improve the implementation's maintainability.

...
$\Domain(\BindingsTree)$ & $=$ & $\set{x_1, x_2, \dots, x_n}$ & when $\BindingsTree = \set{x_i = \EntryStack_i}_{i \in \set{1, 2, \dots, n}}$
\end{tabular}
}
...
$ \Lookup{x_1.x_2.\cdots.x_n}{\set{y_i = \EntryStack_i}_{i \in \set{1, 2, \dots, m}}} $ & $ = $ & when $ \Lookup{x_2.x_3.\cdots.x_n}{\BindingsTree} $ & $ \exists i \in \set{1, 2, \dots, m}, x_i = y_i $ and $ \mathcal{S}_i = \cdots ; (\_, \BindingsTree) $\\
$ \Lookup{x}{\set{y_i = \EntryStack_i}_{i \in \set{1, 2, \dots, m}}} $ & $ = $ & $ e $ & when $ \exists i \in \set{1, 2, \dots, m}, x = y_i $ and $ \mathcal{S}_i = \cdots ; (e, \_) $\\
$ \Lookup{\_}{\_} $ & $ = $ & $ \Fail $ &
\end{tabular}
}
}

...
In the implementation, a scope is a tree of bindings backed by hash tables that map plain identifiers to their definition.
This tree structure allows scopes to uniformly support namespacing.
A lookup for the definition bound to a qualified identifier in a referencing environment searches for the topmost scope whose tree of bindings contains a prefix of that qualified identifier.

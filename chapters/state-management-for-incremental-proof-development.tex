...
Lookups in this environment then proceed by simultaneously traversing the fully qualified identifier and the association list.
...
The expression $x\ z\ (y\ z)$ is indexed with respect to the context $\Psi'$ having $|\Psi| + 3$ entries.
Variables in $\Psi'$ are annotated with the size of the context before each of them was added.
}

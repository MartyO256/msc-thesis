...
This overloading would not translate well in proofs on paper since that could result in an identifier being used to refer to two distinct objects in the same proof.

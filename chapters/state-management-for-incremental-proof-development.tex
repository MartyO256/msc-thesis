...
%The structural editing functionalities of \Harpoon allow end users to develop 
...
The motivation for using an immutable data structure was to get copies of the referencing environment for free during indexing, which could then be attached to proof declarations.

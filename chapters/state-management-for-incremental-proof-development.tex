...
% TODO: Isabelle/Isar supports incremental development with immutable 2-3 balanced treemaps (tables), Earley parsing for mixfix/extensible see My Personal, Ecclectic Isabelle Programming Manual
...
Indeed, most of that system's state, or contexts~\cite{ballarin2006interpretation}, is implemented using immutable 2-3~trees to tabulate data, and each context holds a list of all predecessor states.
...
%TODO: The structural editing functionalities of \Harpoon allow end users to develop proofs in a top-down fashion (state theorems first and then prove them all)
%\Harpoon proof scripts are translated into \Beluga programs 
%In order to preserve soundness of \Harpoon proof sessions with respect to
...
%This includes, among other things, ensuring that input terms are well-typed, 

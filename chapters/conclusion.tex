...
This ensures good runtime performance for the parser, and facilitates the language integration with tools that primarily support context-free languages.
\item

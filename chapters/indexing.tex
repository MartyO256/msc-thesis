...
This additionally increments the size of $\Psi$.
\item
$\Pop{\Psi}{x}{\Xi}$ removes the latest binding of $x$ from $\Xi$ when it is part of the indexing context $\Psi$.
This additionally decrements the size of $\Psi$.
\item
$\Shift{\Psi}{\Xi}$ increments the size of the indexing context $\Psi$ of $\Xi$.
\item
$\Unshift{\Psi}{\Xi}$ decrements the size of the indexing context $\Psi$ of $\Xi$.
\item
...
\end{itemize}
For a given $x$ and $\Psi$, the operation $f(\Xi)=\Pop{\Psi}{x}{\Xi}$ is the right inverse of $g(\Xi)=\Push{\Psi}{x : \tau}{\Xi}$.
Likewise, for a given $\Psi$, the operation $f(\Xi)=\Unshift{\Psi}{\Xi}$ is the right inverse of $g(\Xi)=\Shift{\Psi}{\Xi}$.

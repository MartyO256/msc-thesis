...
\newcommand{\Pop}[3]{\operatorname{pop}_{#1}\left(#2; #3\right)}
...
\newcommand{\Lookup}[2]{\operatorname{lookup}\left(#1; #2\right)}
\newcommand{\Index}[3]{\operatorname{index}_{#1}\left(#2; #3\right)}
